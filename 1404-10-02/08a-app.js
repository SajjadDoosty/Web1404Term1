...
use("file", function (request, response) {
    ...
    fs.readFile(fileName, function (error, fileBody) {
        if (error) {
...
use("pages", function (request, response) {
    fs.readFile(`./${request.url}`, function (error, fileBody) {
        if (error) {
